...
2. **Programming languages** — Python 3 ✅, PHP ✅, JavaScript & TypeScript ✅ (combined: `security-javascript`), C# ✅ (combined with ASP.NET Core: `security-csharp`), Java ✅ (combined with Spring Boot: `security-java`), Kotlin, Clojure, Objective-C, Swift, C/C++, Ruby, Elixir, Go, Rust
